...
function JudgingCriteria() {
  return (
    <section className="py-14 relative border-b border-white/40">
      ...
      <div className="absolute right-0  -bottom-4  w-[150px] h-[150px] md:w-[300px]  md:h-[300px] bg-gradient-to-t from-[#903AFF] to-transparent rounded-full blur-3xl"></div>
      <div className="w-[90%] mx-auto grid md:grid-cols-2 ">
        <div className="self-center relative">
          <div className="absolute -top-10 left-[40%]">
            <img src={purpleStar} alt="purple-star" />
          </div>
          <div className="absolute bottom-0 left-0 w-[150px] h-[150px] md:w-[300px]   md:h-[300px] bg-gradient-to-t from-[#903AFF] to-transparent rounded-full blur-3xl"></div>
